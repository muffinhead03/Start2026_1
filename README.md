...
## 🤖 AI 힌트 시스템
- 플레이어의 체류 시간, 실패 횟수, 발견 단서(completedSteps)를 실시간 분석해 hintLevel 1~5 결정
...
- **퍼즐 기믹 6종**: 6개의 각 스테이지마다 고유한 퍼즐 구조 (와인잔 얼룩 교차점, 오르간 수리 및 연주 등), 현재 Room1과 Room2의 퍼즐·엔티티·AI 힌트 연동을 구현했으며, Room 3~6은 후속 개발 중
...
| Gemini | README 초안, 기본 이동 스크립트, Unity 구현 탐색 | ✅ 실제 상황과 맞는지 검토, 구현 구조가 팀의 의도랑 맞는지 확 |
